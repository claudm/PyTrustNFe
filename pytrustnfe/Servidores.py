...
UFMG = {
    ...
    NFCE_MODELO: {
        AMBIENTE_PRODUCAO: {
            'servidor': 'nfce.sefaz.mg.gov.br',
            WS_NFE_RECEPCAO_EVENTO: 'nfce/services/NFeRecepcaoEvento4',
            WS_NFE_AUTORIZACAO: 'nfce/services/NFeAutorizacao4',
            WS_NFE_RET_AUTORIZACAO: 'nfce/services/NFeRetAutorizacao4',
            WS_NFE_CADASTRO: 'ncfe/services/CadConsultaCadastro4',
            WS_NFE_INUTILIZACAO: 'nfce/services/NFeInutilizacao4',
            WS_NFE_CONSULTA: 'nfce/services/NFeConsultaProtocolo4',
            WS_NFE_SITUACAO: 'nfce/services/NFeStatusServico4',
        ...
        AMBIENTE_HOMOLOGACAO: {
            ...
            WS_NFE_AUTORIZACAO: 'nfce/services/NFeAutorizacao4',
            WS_NFE_RET_AUTORIZACAO: 'nfce/services/NFeRetAutorizacao4',
            WS_NFE_CADASTRO: 'nfce/services/CadConsultaCadastro4',
            WS_NFE_INUTILIZACAO: 'nfce/services/NFeInutilizacao4',
            WS_NFE_CONSULTA: 'nfce/services/NFeConsultaProtocolo4',
            WS_NFE_SITUACAO: 'nfce/services/NFeStatusServico4',
            WS_NFCE_QR_CODE: 'nfce.fazenda.mg.gov.br/portalnfce/sistema/qrcode.xhtml',
